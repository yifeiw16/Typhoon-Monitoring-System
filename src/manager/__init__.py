...
@login_required
def index():
    user_cnt, typhoon_cnt, order_cnt, news_cnt = util.dataStatic()
    user_list, typhoon_list, order_list, news_list = util.timeDataStatic()
    print(typhoon_cnt, typhoon_list)
    return render_template("/manager/index.html",
                           user_cnt = user_cnt, typhoon_cnt = typhoon_cnt,
                           order_cnt = order_cnt, news_cnt = news_cnt,
                           user_list = user_list, typhoon_list = typhoon_list,
