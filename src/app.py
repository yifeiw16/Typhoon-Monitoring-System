...
from manager.typhoon import manager_typhoon as manager_typhoon_blueprint
...
from user.typhoon import user_typhoon as user_typhoon_blueprint
...
# 注册蓝图
app.register_blueprint(manager_typhoon_blueprint, url_prefix = '/manager/typhoon')
...
app.register_blueprint(user_typhoon_blueprint, url_prefix = '/user/typhoon')
